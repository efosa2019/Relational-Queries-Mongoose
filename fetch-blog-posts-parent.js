...
const Post = mongoose.model('Post', { name: String, url: String, text: String })
...
let post = new Post({
  ...
  text:
    'This essay will give you a quick introduction to ES6. If you donâ€™t know what is ES6, itâ€™s a new JavaScript implementation.',
})
...
post.save(function (err) {
  ...
  let ca = [
    ...
    {
      text:
        'I think youâ€™re undervaluing the benefit of â€˜letâ€™ and â€˜constâ€™.',
    },
